...
namespace voila::mlir
{
    namespace lowering
    {
        ...
        struct VoilaToLLVMLoweringPass : public PassWrapper<VoilaToLLVMLoweringPass, ::mlir::OperationPass<ModuleOp>>
        {
        ...
        void VoilaToLLVMLoweringPass::runOnOperation()
        {
            ...
            // FIXME: populateMemRefToLLVMConversionPatterns(typeConverter, patterns);
