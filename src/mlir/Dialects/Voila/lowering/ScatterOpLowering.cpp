                                                             ...
                                                             ::mlir::ConversionPatternRewriter &rewriter) const
    {
        ...
        else
        {
            out = builder.create<memref::AllocOp>(
                ...
                llvm::makeArrayRef<Value>(builder.create<tensor::DimOp>(scatterOpAdaptor.getIdxs(), 0)));
        }
        ...
        buildAffineLoopNest(rewriter, loc, llvm::makeArrayRef<Value>(builder.create<ConstantIndexOp>(0)),
                            llvm::makeArrayRef<Value>(builder.create<tensor::DimOp>(scatterOpAdaptor.getIdxs(), 0)), {1},
                            loopFunc);
